  ...
  <div class="slider-container light rev_slider_wrapper" >
    ...
    <!--<div class="col-md-4 newsletter">
      ...
      <ul>
		...
		?>
        <li data-transition="notransition"> <img class="img-res" src="<?php echo $banner_img_url; ?>"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
         
          <div class="tp-caption"
         data-x="1010" data-hoffset="0"
         data-y="-70"
         data-start=""
         style="z-index: 5"
         data-transform_in="">
            <div class="header-search hidden-xs">
              <form class="search" action="<?php echo get_home_url('','','https'); ?>" method="get">
                <input name="s" type="text" class="searchbox1" placeholder="Search..." required >
                ...
                <a class="close"> <img src="<?php bloginfo('template_directory'); ?>/img/icon-close.png" /> </a>
              </form>
            </div>
          </div>
          <div class="tp-caption main-label "
                                     ...
                                     style="z-index: 5;line-height: 70px;"
                                     data-mask_in="x:0px;y:0px;"><span class="white"><?php echo $banner_settings[0]['banner-title']; ?></span></div>
          <div class="tp-caption bottom-label"
                                     data-x="center" data-hoffset="0"
                                     data-y="315"
                                     data-start="2000"
                                     style="z-index: 9999"
                                     data-transform_in="y:[100%];opacity:0;s:500;"><a href="<?php echo $banner_settings[0]['button-link']; ?>" class="whitebox"><?php echo $banner_settings[0]['button-label']; ?></a></div>
        </li>
        <?php
					}
					else
        ...
        <li data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-description="" class="tp-revslider-slidesli rs-pause-timer-always">
          <div class="rs-background-video-layer"  
            ...
            <?php /*?><div class="top-head">
                ...
                <input name="s" type="text" class="searchbox1" placeholder="Search..." required>
                <input type="image" src="<?php bloginfo('template_directory'); ?>/img/icon-search.png" alt="Submit" width="23" height="23" name='submit' class='enableOnInput submitBtn'/>
                <a class="close"> <img class="img-responsive close-icon" src="<?php bloginfo('template_directory'); ?>/img/icon-close.png" /> </a>
                </form>
                </div>
            ...
            <div class="tp-caption main-label "
                                     ...
                                     data-transform_out="opacity:0;s:500;"
                                     style="z-index: 5;line-height: 70px;"
                                     data-mask_in="x:0px;y:0px;"><span class="white"><?php echo $background_vid['video-title']; ?></span></div>
            <div class="tp-caption Desc-text "
                                     data-x="center" data-hoffset="0"
                                     data-y="270"
                                     data-start="1500"
                                     data-whitespace="nowrap"						 
                                     data-transform_in="y:[100%];s:500;"
                                     data-transform_out="opacity:0;s:500;"
                                     style="z-index: 5;line-height: 35px;"
                                     data-mask_in="x:0px;y:0px;"><span class="white-desc"><?php echo $background_vid['video-description']; ?></span></div>
            <div class="tp-caption bottom-label"
            data-x="center"
            data-y="340"
            style="z-index: 5"><a href="<?php echo $background_vid['button-link']; ?>" class="whitebox"><?php echo $background_vid['button-label']; ?></a></div>
        </li>
        <?php } 
		//}?>
      </ul>
