...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'blog-thumb-twentysix', 135, 240, array( 'center', 'top' ) );//gallery 


    add_image_size( 'blog-thumb-fifty', 50, 50, array( 'center', 'top' ) );
}
...
?>
    ...
    <div class="title-post-inner-page highlight_tag">
            <?php
            $text_to_replace = "<span>" . $tag_name . "</span>";
            $title_details = strtolower($post->post_title);
            $bodytag = str_replace($tag_name, $text_to_replace, $title_details);
            echo $bodytag;
            ?></div>                                    
    </a>
    </div>
    ...
    <div class="title-post-inner-page highlight_tag">
            <?php
            $text_to_replace = "<span>" . $tag_name . "</span>";
            $title_details = strtolower($blog->post_title);
            $bodytag = str_replace($tag_name, $text_to_replace, $title_details);
            echo $bodytag;
            ?></div>                                    
    </a>
...
?>
        ...
        ?>
            <div class="videolist col-50 mobi-ply">
                <a href="<?php echo get_permalink($post->ID); ?>" class="fashion">         
                 ...
                 <div class="title_post_mobile highlight_tag">
    ...
    <div class="videolist col-50 mobi-ply">
                <a href="<?php echo get_permalink($blog->ID); ?>" class="fashion">         
                 ...
                 <div class="title_post_mobile highlight_tag">
                <a href="<?php echo get_permalink($blog->ID); ?>"><?php
            $text_to_replace = "<span>" . $tag_name . "</span>";
            $title_details = strtolower($blog->post_title);
            $bodytag = str_replace($tag_name, $text_to_replace, $title_details);
            echo $bodytag;
