...
<div class="owl-carousel owl-theme manual main-blog-page-nav" id="blog_posts_slider" >
<?php while ($my_query->have_posts()) : $my_query->the_post(); ?>		
		...
		<div class="item">
			...
			<span class="blog-page-slider-hover"><a class="blog-post-title" href="<?php the_permalink(); ?>"><span class="hover-color-title"><?php echo wp_trim_words( get_the_title(), 3, '' ); ?></span></a></span>
		</div>		
<?php endwhile; ?>
