...
mysql_connect(DB_HOST, DB_USER, DB_PASSWORD) or die("DB Connection failed" . mysql_error());
...
function wpdocs_scripts_method() {
    wp_enqueue_script( 'selectric-script', get_stylesheet_directory_uri() . '/js/jquery.selectric.min.js', array( 'jquery' ) );
