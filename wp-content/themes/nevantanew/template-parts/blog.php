...
<!--<div class="container">
<div class="col-md-12">-->
<div class="owl-carousel owl-theme manual" id="blog_posts_slider" >
<?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
		<?php			
			
			$image_data = wp_get_attachment_image_src(get_post_thumbnail_id(), 'blog-thumb-tenth');
			$imagesrc = $image_data[0];
			
		?>
		<div class="item">
			<a href="<?php the_permalink(); ?>">
				<!--<img class="img-res" src="<?php echo $image['url']; ?>" width="<?php echo $image['width']; ?>" height="<?php echo $image['height']; ?>" />-->				
		...
		<main id="main" class="site-main" role="main">
			<div class="col-md-12">
				...
				<?php 
					...
					$imagesrc = basename($image_data[0]);*/
					
					if (MobileDTS::is('ios') || MobileDTS::is('mobile') || MobileDTS::is('android')) {
						$thumb_width = 330;
						$thumb_height = 283;
						$image_data = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'blog-thumb-first');
						$imagesrc = basename($image_data[0]);
					}
					else{
						if( $i == 1 || $i == 2 || $i == 6 || $i == 7 ){
...
the_title();
								 ...
								 ?></h2></a>
								<!--<p class="blog-excerpt"><?php //echo wp_trim_words( get_the_content(), 25, '...' ); ?></p>-->
			...
			?> </p>
                    ...
                    <?php if($i == 3){$image_mar="nopad-left";}
						...
						<?php //} 	?>
								<a href="<?php the_permalink(); ?>">
									<img class="img-res" src="<?php echo $imagesrc; ?>" width="<?php echo $thumb_width; ?>" height="<?php echo $thumb_height; ?>" />				</a>
							</div>
							<?php
							if (MobileDTS::is('ios') || MobileDTS::is('mobile') || MobileDTS::is('android')) {
								if($i == 3){ ?>
