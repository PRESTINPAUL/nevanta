...
<div class="blog-slider-page tagpage">
<amp-carousel width="500" height="500" layout="responsive" type="slides" autoplay controls loop arrows dots='.'>
        ...
        <?php 
            ...
            //$image = vt_resize( $thumb, '', 350, 526, true );
        ?>
					...
					<div class="blog-post-pagination">
						<?php if($paged != 1){ 
							if($paged == $my_query->max_num_pages){
								...
								previous_posts_link( '<div class="intermediate-pages"><div class="blog-post-newer intermediate-pages-newer"><h4>Newer Posts</h4></div>' );
							}
						} 
						if($paged != $my_query->max_num_pages){
							if($paged == 1){
