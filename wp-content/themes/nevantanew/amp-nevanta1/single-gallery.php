...
<body class="front-page post-single-gallery-page">
    ...
    <main>  
		...
		?>			                                  
            <amp-img layout="responsive" src="<?php the_post_thumbnail_url('full', array('class' => 'img-res'));?>" width="308" height="495" alt="<?php the_title(); ?>"></amp-img>
            ...
            <!--<div class="amp-wp-content relatedpost">
              <div class="related_posts">
                <ol class="clearfix">
                  ...
                  <amp-carousel width="400" height="350" layout="responsive" type="slides" autoplay controls loop arrows dots='.'>                   
                  <?php
                $related = get_posts( array( 'category__in' => wp_get_post_categories($post->ID), 'numberposts' => 5, 'post__not_in' => array($post->ID) ) );
                if( $related ) foreach( $related as $post ) { setup_postdata($post); ?>
                	 <div>                        
        			<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>">                                          
                    <amp-img src="<?php the_post_thumbnail_url('full', array('class' => 'img-res'));?>" width="400" height="150" alt="<?php the_title(); ?>"></amp-img>                </a>                                                          
                    <?php
					echo "<br>";					
