...
class RM_View {
    ...
    static function searchBar() { 
		...
		$action = function_exists( 'icl_get_home_url' ) ? icl_get_home_url() : get_home_url('','','https'); ?>
		
		<form action="<?php echo $action; ?>" id="responsiveSearch" method="get" role="search">

            <input type="text" class="form-control blacksearch" name="s" value="<?php echo $_GET['s']; ?>" placeholder="<?php _e( 'SEARCH NEVANTA', 'responsive-menu' ); ?>" id="responsiveSearchInput" required>
